...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://8mced8mixf.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.musicbotOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var musicbotOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/musicbot').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(musicbotOptionsRequest, authType, additionalParams, config.apiKey);
    };
